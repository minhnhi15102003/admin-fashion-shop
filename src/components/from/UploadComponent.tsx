...
const UploadComponent = (
  { title, multiple, onChangeFile }:
    { title: string, multiple: boolean, onChangeFile: (file: File[]) => void }) => {
  ...
  return (
    <ComponentCard title={title}>
      <div className="transition border border-gray-300 border-dashed cursor-pointer rounded-xl hover:border-brand-500">
        <div
          {...getRootProps()}
          className={`dropzone rounded-xl border-dashed border-gray-300 p-7 lg:p-10 bg-white 
            ${isDragActive
          ...
          <div className="dz-message flex flex-col items-center m-0!">
            ...
            {/* Text Content */}
            <h4 className="mb-3 font-bold text-gray-800 text-theme-xl">
